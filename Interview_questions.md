...
* **If Yes:** "Yes, I am a **Certified Development Associate – SAP Integration Suite (C_CPI_14 or C_CP_11)**."
* **If No:** "I haven't completed the formal certification yet, but I have extensive hands-on experience in building complex I-Flows, handling Groovy scripts, and managing security artifacts in real-world environments."
...
* **Web-based UI:** Development happens in a browser, removing the need for local Java-based tools like the NWDS used in PO.
